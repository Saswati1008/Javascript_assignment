...
const countries = {
  India: { capital: 'New Delhi', population: '1.4B', languages: ['Hindi','English'] },
  USA: { capital: 'Washington D.C.', population: '331M', languages: ['English'] }
};

for (let country in countries) {
  console.log(country, countries[country].capital, countries[country].population, countries[country].languages);
}
...
let personAccount = {
  ...
  addIncome: function(desc, amt) { this.incomes.push({description: desc, amount: amt}); },
  addExpense: function(desc, amt) { this.expenses.push({description: desc, amount: amt}); }
};
